...
func Enter():
	...
	await Global.player.combat.attack()  # Call the attack method from the player combat script
...
func Physics_Update(delta: float):
	...
	Global.player.movement.velocity = Global.player.movement.velocity * .9
