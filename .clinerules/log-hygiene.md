...
| `refactorPlan.md`, `devPlan.md` | Tasks are deleted on completion (noted in `progress.md`). Keep each under ~80 lines; no status columns or dates — task IDs plus `progress.md` carry state. |
